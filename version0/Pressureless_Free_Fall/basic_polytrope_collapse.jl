...
include("free_fall_finite_difference_update_v2.jl")
...
evolve_collapse(rho, velocity, gravity, grav_accel, r, dr, t_ff, dt, steps=10, save_every=1, output_file="pressureless_collapse_run.h5")
